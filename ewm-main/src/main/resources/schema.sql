...
(
    ...
    CONSTRAINT FK_EVENT_RATE FOREIGN KEY (event_id) REFERENCES EVENTS (ID) ON DELETE CASCADE,
    CONSTRAINT FK_USER_RATE FOREIGN KEY (USER_ID) REFERENCES USERS (ID) ON DELETE CASCADE,
